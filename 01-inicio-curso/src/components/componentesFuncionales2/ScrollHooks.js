...
export function ScrollHooks(){
  ...
  //Use efect tiene 2 parametros, el primero una funcion flecha con el codigo que queremos que se ejecute, y el segundo una lista de dependencia "dependency list", un arreglo al que le pasamos una variable de estado que queremos estar controlando. 
  //hay 3 modos de uso:
